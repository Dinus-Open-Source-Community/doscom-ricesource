...
export default function AddRicePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // const response = await fetch('/api/rices', {
            //   method: 'POST',
            //   headers: {
            ...
            toast({
                title: "Success",
                description: "Rice configuration has been added successfully.",
            })
            router.push("/manage-rice")
        } catch (error) {
            toast({
                title: "Error",
                description: "Failed to add rice configuration. Please try again.",
                variant: "destructive",
            })
        } finally {
            setIsLoading(false)
    ...
    return (
        <div className="container mx-auto py-8">
            <Card>
                <CardHeader>
                    <CardTitle>Add New Rice Configuration</CardTitle>
                </CardHeader>
