...
router.post('/komentar', userAuthMiddleware, validateCreateKomentar, createKomentar);
router.get('/komentar/:config_id', validateGetKomentar, getKomentar);
router.delete('/komentar/:id', userAuthMiddleware,validateDeleteKomentar, deleteKomentar);
