  ...
  async toggleLike(req, res) {
    ...
    try {
      ...
      if (existingLike) {
        ...
        await supabase.rpc("decrement_like_count", {p_config_id: parseInt(configId)})
        ...
        // menambahkan like di table like counts
        await supabase.rpc("increment_like_count", {p_config_id: Number(configId)})
